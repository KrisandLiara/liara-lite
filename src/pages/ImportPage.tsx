                ...
                <div className="flex gap-2 items-center mt-1">
                  <Button asChild variant="outline" size="sm">
                    <Link
                      to={
                        selectedEnrichedFile
                          ? `/data-explorer?file=${encodeURIComponent(selectedEnrichedFile)}`
                          : "/data-explorer"
                      }
                    >
                      Data Explorer
                  ...
                  <Button asChild variant="outline" size="sm">
                    <Link
                      to={
                        selectedEnrichedFile
                          ? `/date-explorer-test?file=${encodeURIComponent(selectedEnrichedFile)}`
                          : "/date-explorer-test"
                      }
                    >
                      Date Explorer (TEST)
                  ...
                  <Button asChild variant="outline" size="sm">
                    <Link
                      to={
                        selectedEnrichedFile
                          ? `/maps-lab?file=${encodeURIComponent(selectedEnrichedFile)}`
                          : "/maps-lab"
                      }
                    >
                      Maps Lab (TEST)
